    ...
    <div class="container my-5 py-5">
        <div class="row">
            ...
            <div class="col-9 my-4 pe-5">
                <h6><b>이력서 <div class="badge count-color px-2 " style="font-weight: 900; font-size: 16px;"> ${rDtos.size()}</div></b></h6>
                <div class="card mb-2">
                                                ...
                                                <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="d-flex justify-content-around">
                                                                <div >
                                                                    <h6 class="card-subtitle mb-2">${rDto.career}
                                                                    </h6>
                                                                </div>
                                                                <div >
                                                                    <h6 class="card-subtitle mb-2">${rDto.address}
                                                                    </h6>
                                                                </div>
