    ...
    <%@ include file="../layout/header.jsp" %>
        ...
        <body>
            ...
            <div class="container-fluid width-53 top-80">
                ...
                <br>
                <textarea name="text-align" cols="130" rows="1"
                    placeholder="제목(예) 이벤트 신청 문의 | 보상금 신청 | 수수료 정산 등"></textarea>
                <br>
                <div style="margin-top: 30px;"></div>
                ...
                <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 0.9em;">①개인정보 수집
                    항목: 이메일,
                    연락처</div>
                <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 0.9em;">②수집목적:
                    고객식별, 문의 응대,
                    서비스 품질 향상</div>
                ...
                <div style="font-weight: bold;"><input type="checkbox"> 동의합니다.
                    <div style="color: red; display: inline;">*</div>
                </div>
