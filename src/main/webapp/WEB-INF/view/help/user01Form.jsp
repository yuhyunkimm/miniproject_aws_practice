    ...
    <%@ include file="../layout/header.jsp" %>
        ...
        <body>
            ...
            <div class="container-fluid width-53 top-80">
                ...
                <div style="font-weight: bold; font-size: 0.8em; display:inline; margin-left : 0.1em;">보상금ㆍ뉴스타트 패키지
                </div>
                ...
                <h3 style="font-size: 1.1em; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
                    지인의 추천은 늘 힘이 됩니다</h3>
                <h3
                    style="font-size: 1.1em; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; display:inline;">
                    합격자와 추천인</h3>
            ...
            display:inline;">
                ...
                <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; display:inline;">합격자에 한해 50만원
                    지급</div>
                <br>
