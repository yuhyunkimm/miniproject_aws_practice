            ...
            <div class="container-fluid width-53 top-80">
                ...
                <div style="text-align : center;">
                    <form action="/login" method="post">
                        ...
                        <input class="form_input" type="text" size="38px" style="font-size: 1.3em; "
                            placeholder="비밀번호를 찾고싶어요." autofocus>
                    </form>
                        ...
                        <div style="display: flex; justify-content: center; margin-bottom: 100px;">
                            <div style="text-align: left; margin-right: 3em;">
                                ...
                                <div class="menu_bar">
                                    <button type="button"
                                        ...
                                        <div class="div_category">
                                            <div style="font-weight : bold; font-size: 1.7em; color: rgb(86, 87, 87);">
                                                개인회원
                                            </div>
                                        </div>
                                ...
                                <div class="top_category">
                                    ...
                                    <div class="textmargin"><a href="/help/user04Form"
                                            style="color: black; text-decoration: none;">보상금 지급 정보를 늦게 제출 했습니다. 어떻게
                                            되나요?</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="text-align: left;">
                                ...
                                <div style="margin-top: 100px;">
                                    <h2 style="font-size: 1.7em; text-align: center; margin-right: 83px;">기업회원 자주묻는 질문
                                    </h2>
                                    <div class="top_category">
                                        ...
                                        <div class="textmargin"><a href="/help/job04Form"
                                                style="color: black; text-decoration: none; margin-right: 30px;">최종 합격
                                                처리 후, 채용
                                                수수료 정산은 어떻게 하나요?</a>
                                        </div>
                                        ...
                                        <div class="textmargin"><a href="/help/job03Form"
                                                style="color: black; text-decoration: none; margin-right: 30px;">면접 진행은
                                                어떻게
                                                하나요?</a></div>
                                        <div class="textmargin"><a href="/help/job02Form"
                                                style="color: black; text-decoration: none; margin-right: 30px;">원하는
                                                직군/직무를 추가하고
                                                싶어요</a></div>
                                    </div>
                                </div>
